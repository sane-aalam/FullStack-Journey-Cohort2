// Swiggy Application - API(JSON Data)
// front-end (how to access api data) 
...
console.log(restaurantList[1].info.name);
console.log(restaurantList[2].info.name);
console.log(restaurantList[3].info.name);
console.log(restaurantList[0].info.areaName);
